...
para=[0.1,0.15,0.2,0.25,0.3]
id_1325=[0,0,12,58,469]
id_76=[0,0,1,58,238]
id_14=[0,0,1,1,21]
id_67=[0,0,14,113,212]
id_18=[17,1,1,2,6]
plt.plot(para, id_1325, '.-', c='blue',label="ID1325")
plt.plot(para, id_76, '.-', c='green',label="ID76")
plt.plot(para, id_14, '.-', c='red',label="ID14")
plt.plot(para, id_67, '.-', c='gray',label="ID67")
plt.plot(para, id_18, '.-', c='steelblue',label="ID18")
plt.xlabel('$b_{FoF}$')
plt.ylabel('Number of Clusters')
plt.legend()
plt.savefig('fof_link' + ".pdf", format='pdf', dpi=100, bbox_inches='tight')
plt.show()
